...
This self-test checks whether the current Main Pal or owner Pal handles composite deliverable tasks without keyword routing.
...
- Mira outputs Pal / Runtime / Skill candidates, not fixed routes.
