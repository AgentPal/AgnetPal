---
name: regression-plan-writer
description: Use this skill when you need to 按改动范围和风险设计核心路径、边界和回归测试计划。
---

# regression-plan-writer

## Purpose

按改动范围和风险设计核心路径、边界和回归测试计划。
...
- Runtime entry: skills/regression-plan-writer/SKILL.md
- Human notes: skills/regression-plan-writer/README.md
- Parent index: skills/index.md

依赖 change-scope-review 和 risk-assessment 的范围判断。
