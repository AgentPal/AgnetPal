...
description: Use this skill when you need to 为功能、流程、文档或 Agent 任务生成可验收的测试用例。
---
...
- Runtime entry: skills/test-case-design/SKILL.md
- Human notes: skills/test-case-design/README.md
