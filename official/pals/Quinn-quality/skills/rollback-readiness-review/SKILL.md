...
description: Use this skill when you need to 检查发布、迁移、删除、配置和数据变更是否具备回滚或降级路径。
---
...
- Runtime entry: skills/rollback-readiness-review/SKILL.md
- Human notes: skills/rollback-readiness-review/README.md
- Parent index: skills/index.md

为 release-gate-review 判断是否可发布提供回滚证据。
