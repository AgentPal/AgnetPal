...
description: Use this skill when you need to 检查目标和验收标准是否清楚、可验证、覆盖关键路径。
---
...
- Runtime entry: skills/acceptance-criteria-review/SKILL.md
- Human notes: skills/acceptance-criteria-review/README.md
- Parent index: skills/index.md

常与 test-case-design、evidence-audit、quality-report-writer 配合。
