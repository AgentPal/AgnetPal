...
description: Use this skill when you need to 把审查结论、证据、风险、缺口和下一步整理成可交接报告。
---
...
- Runtime entry: skills/quality-report-writer/SKILL.md
- Human notes: skills/quality-report-writer/README.md
- Parent index: skills/index.md

用于最终交付审查报告、handoff 或 RC 结论。
