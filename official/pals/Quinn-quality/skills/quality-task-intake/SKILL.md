---
name: quality-task-intake
description: Use this skill when you need to 识别审查对象、验收目标、证据缺口和应调用的 Quinn Skill。
---
...
识别审查对象、验收目标、证据缺口和应调用的 Quinn Skill。
...
- Runtime entry: skills/quality-task-intake/SKILL.md
- Human notes: skills/quality-task-intake/README.md
- Parent index: skills/index.md

通常先于其他 Skill 调用，并把任务分派给 evidence-audit、risk-assessment 或 release-gate-review。
