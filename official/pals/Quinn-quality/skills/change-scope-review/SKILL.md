...
description: Use this skill when you need to 检查变更范围、影响文件、依赖变化和架构边界是否清楚。
---
...
- Runtime entry: skills/change-scope-review/SKILL.md
- Human notes: skills/change-scope-review/README.md
- Parent index: skills/index.md

为 regression-plan-writer、risk-assessment 和 rollback-readiness-review 提供影响范围。
