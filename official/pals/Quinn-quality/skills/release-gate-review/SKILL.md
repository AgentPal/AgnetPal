...
description: Use this skill when you need to 检查发布前功能、证据、风险、回滚、说明和人工确认是否齐备。
---
...
- Runtime entry: skills/release-gate-review/SKILL.md
- Human notes: skills/release-gate-review/README.md
- Parent index: skills/index.md

汇总 acceptance-criteria-review、evidence-audit、risk-assessment 和 rollback-readiness-review。
