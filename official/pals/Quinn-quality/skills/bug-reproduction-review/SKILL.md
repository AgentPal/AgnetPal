---
name: bug-reproduction-review
description: Use this skill when you need to 审查 Bug 复现材料是否足以交给执行层定位和修复。
---

# bug-reproduction-review

## Purpose

审查 Bug 复现材料是否足以交给执行层定位和修复。
...
- Runtime entry: skills/bug-reproduction-review/SKILL.md
- Human notes: skills/bug-reproduction-review/README.md
- Parent index: skills/index.md

输出可由当前 owner 逐案交给从 contacts / registry 解析出的合适协作对象或目标 Runtime 的复现任务包。
