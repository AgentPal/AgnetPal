---
name: evidence-audit
description: Use this skill when you need to 审查 Runtime、Agent 或交付报告提供的证据是否足以支撑完成声明。
---
...
审查 Runtime、Agent 或交付报告提供的证据是否足以支撑完成声明。
...
- Runtime entry: skills/evidence-audit/SKILL.md
- Human notes: skills/evidence-audit/README.md
- Parent index: skills/index.md

是 release-gate-review、quality-report-writer 和 Codex 完成审计示例的核心输入。
