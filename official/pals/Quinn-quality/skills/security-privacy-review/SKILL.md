...
description: Use this skill when you need to 做基础安全、权限、敏感信息和外发隐私检查。
---
...
- Runtime entry: skills/security-privacy-review/SKILL.md
- Human notes: skills/security-privacy-review/README.md
- Parent index: skills/index.md

高风险发现会阻断 release-gate-review，并要求用户确认或专业审计。
