...
from_pal: product-pal
to_pal: resolved-implementation-pal
...
needed_output: Implementation task package, implementation lanes, tests, and evidence requirements.
