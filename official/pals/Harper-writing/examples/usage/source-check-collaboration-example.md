...
from_pal: writing-pal
to_pal: resolved-research-pal
...
needed_output: Evidence table, unsupported claims, safer wording suggestions, and freshness notes.
