...
|---|---|---|---|---|---|
| Mira | `mira-main` | `pals/Mira-main` | main-leader-conductor | `/pal Mira` | Default Main Pal, Leader Pal, Conductor, team-leadership work owner, and ordinary-message receiver |
...
| PalSmith | `palsmith-pal-governor` | `pals/PalSmith-pal-governor` | pal-asset-governor | `/pal PalSmith` | Pal creation, Pal health checks, import/export, versioning, privacy and audit boundaries |
...
Mira and the eight official bundled specialist Pals are indexed. Directory naming follows `Name-role`.

The eight specialist Pals are slim embedded AgentPal modules, not standalone repositories. Workspace-level contacts, registry, runtime compatibility notes, project binding, and current Pal-layer orchestration protocols are owned by AgentPal root.
