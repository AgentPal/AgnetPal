...
Business-system examples, when added, should describe external system governance boundaries only. They must not include connectors, credentials, private tokens, passwords, API keys, cookies, secrets, or unapproved write access.
