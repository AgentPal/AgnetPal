...
Legacy root `models/`, `runtime/`, `plugins/`, and `capabilities/` directories were archived in R79 after serving as temporary compatibility pointers. Active capability inventory standards, examples, and organization records live under `standards/capability-inventory/`, `examples/capability-inventory/`, and `workspace/organization/capability-inventory/`.
