...
| --- | --- | --- | --- |
| `capabilities/README.md` | compatibility pointer | `archive/migration-from-v0.3/root-legacy/capability-inventory/root-pointers/capabilities/README.md` | archived in R79 |
...
| `runtime/README.md` | compatibility pointer | `archive/migration-from-v0.3/root-legacy/capability-inventory/root-pointers/runtime/README.md` | archived in R79 |
...
| `models/README.md` | compatibility pointer | `archive/migration-from-v0.3/root-legacy/capability-inventory/root-pointers/models/README.md` | archived in R79 |
...
| `plugins/README.md` | compatibility pointer | `archive/migration-from-v0.3/root-legacy/capability-inventory/root-pointers/plugins/README.md` | archived in R79 |
